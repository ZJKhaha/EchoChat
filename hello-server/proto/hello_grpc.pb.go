...
type SayHelloClient interface {
	SayHello(ctx context.Context, in *HelloResquest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *sayHelloClient) SayHello(ctx context.Context, in *HelloResquest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
type SayHelloServer interface {
	SayHello(context.Context, *HelloResquest) (*HelloResponse, error)
...
func (UnimplementedSayHelloServer) SayHello(context.Context, *HelloResquest) (*HelloResponse, error) {
...
func _SayHello_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayHelloServer).SayHello(ctx, req.(*HelloResquest))
	}
